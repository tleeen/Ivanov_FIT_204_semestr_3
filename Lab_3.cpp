...
int main()
{
    ...
    do
    {
        ...
        case 3:
        {
            ...
            cout << "\nFigure #1 (triangle):";
            figure[0] = new Triangle(0, 0, 30, 0, 40, 0);
            prism[0] = new Prism<Figure>(-10, figure[0]);

            try
            {
                if (prism[0]->h < 0) throw "Отрицательное значеные высоты призмы";
                cout << figure[0]->String();
                cout << "\nVolume: ";
            ...
            cout << "\n\nFigure #2 (circle):";
            figure[1] = new Circle(0, 0, 0, 20);
            prism[1] = new Prism<Figure>(-2, figure[1]);

            try
            {
                if (prism[1]->h < 0) throw "Отрицательное значеные высоты призмы";
            ...
            try
            {
                if (prism[2]->h < 0) throw "Отрицательное значеные высоты призмы";
            ...
            try
            {
                if (prism[3]->h < 0) throw "Отрицательное значеные высоты призмы";
            ...
            try
            {
                if (prism[4]->h < 0) throw "Отрицательное значеные высоты призмы";
